            ...
            <div class="row g-2">
                <div class="col-12 col-lg-6 w-100">
                    ...
                    <div class="d-block rounded shadow bg-white p-3 mt-3">
                        <div class="cust-table">
                            <div class="d-flex justify-content-between  flex-wrap gap-5 title-table w-100">
                                <form action="{{ route('Category.Store.Admin.Put', $category->id_category_admin) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <table>
                                        <tr>
                                            <td class="ps-5 pe-3 "><label for="nama" class="mb-3">Nama
                                                    Kategori</label></td>
                                            <td class="pe-3 ">
                                                <p class="mb-3">:</p>
                                            </td>
                                            ...
                                            <td>
                                                <input type="text" name="category" class="mb-3 form-control"
                                                    placeholder="isi kategori..." value="{{ $category->category }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="icon" class="form-control"
                                                    placeholder="isi icon" value="{{ $category->icon }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td><button type="submit" name="submit" class="mt-3 btn btn-primary">UBAH
                                                </button></td>
                                        </tr>
                                    </table>
                                </form>
