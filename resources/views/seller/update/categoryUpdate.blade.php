                                ...
                                <form action="{{ route('Category.Update',$category->id_category) }}" method="POST">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-select" name="category" id="category" class="select-form">
                                                    <option value="Makanan"
                                                        {{ $category->category == 'Makanan' ? 'selected' : '' }}>Makanan
                                                    </option>
                                                    <option value="Minuman"
                                                        {{ $category->category == 'Minuman' ? 'selected' : '' }}>Minuman
                                                    </option>
                                                    <option value="Pakaian"
                                                        {{ $category->category == 'Pakaian' ? 'selected' : '' }}>Pakaian
                                                    </option>
                                                    <option value="Elektronik"
                                                        {{ $category->category == 'Elektronik' ? 'selected' : '' }}>Elektronik
                                                    </option>
                                                    <option value="Buku"
                                                        {{ $category->category == 'Buku' ? 'selected' : '' }}>Buku</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
